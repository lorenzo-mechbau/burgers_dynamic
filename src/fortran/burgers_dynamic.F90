...
#include "mpif.h"
  ...
  LINEAR_SOLVER_DIRECT_FLAG=.FALSE. ! TRUE requires CMFE_EQUATIONS_SPARSE_MATRICES AND CMFE_SOLVER_SPARSE_MATRICES!!
                                    ! Defaults is FALSE with FULL matrices (fails from time to time)   
